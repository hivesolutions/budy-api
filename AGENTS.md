...
To run the custom suite of unit test for Budy API use the following sequence of commands that will install dependencies
...
Budy API is licensed under the [Apache License, Version 2.0](http://www.apache.org/licenses/).
